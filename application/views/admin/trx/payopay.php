                ...
                <div class="col-xxl-12">
                    ...
                    <div class="card card-xxl-stretch">
                        ...
                        <div class="card-header border-0 pt-5 pb-3" style="display: flex; align-items: center;">
                            <!--begin::Card title-->
                            <img src="<?php echo base_url('assets/media/logos/payopay.png'); ?>" alt="BRI Logo" style="width: 150px;">
                            ...
                            <H6 class="card-title fw-bolder text-gray-800 fs-2"> <?php if ($saldo_payopay > 0) : ?>
                                    <small class="text-blue-500"> Saldo Anda: Rp <?php echo number_format($saldo_payopay, 0, ',', '.'); ?></small>
                                <?php else : ?>
                                    <p>Saldo Anda kosong.</p>
                                <?php endif; ?>
                            </H6>
...
<div class="modal fade" id="trxModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-image: url('<?php echo base_url('assets/media/logos/payopay.png'); ?>'); background-size: 100px; background-repeat: no-repeat; background-position: center center;">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="kategori" id="kategori">
                            ...
                            <?php foreach ($kategori_data as $kategori) : ?>
                                <?php if (in_array($kategori['id'], [5, 12])) : ?>
...
<script>
    ...
    function tambahTrx() {
        ...
        xhttp.open("POST", "<?php echo base_url('admin/trx/tambah_trx_payopay'); ?>", true);
    ...
    function prosesPembayaran() {
        ...
        $.ajax({
            url: '<?php echo base_url("admin/trx/bayar_trx_payopay"); ?>',
            type: 'POST',
            data: {
                id: idTransaksi,
                jml_byr: jmlByr
    ...
    function batalkanTransaksi(id) {
        $.ajax({
            type: "POST",
            url: "<?php echo base_url("admin/trx/batalkan_trx_payopay"); ?>",
            data: {
                idTrx: id
            },
    ...
    function prosesHapus(id) {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url("admin/trx/hapus_trx_payopay"); ?>', // Ganti dengan URL yang sesuai untuk menghapus data
            data: {
                id: id

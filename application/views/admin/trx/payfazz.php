                ...
                <div class="col-xxl-12">
                    ...
                    <div class="card card-xxl-stretch">
                        ...
                        <div class="card-header border-0 pt-5 pb-3" style="display: flex; align-items: center;">
                            <!--begin::Card title-->
                            <img src="<?php echo base_url('assets/media/logos/payfazz.png'); ?>" alt="BRI Logo" style="width: 150px;">
                            ...
                            <H6 class="card-title fw-bolder text-gray-800 fs-2"> <?php if ($saldo_payfazz > 0) : ?>
                                    <small class="text-blue-500"> Saldo Anda: Rp <?php echo number_format($saldo_payfazz, 0, ',', '.'); ?></small>
                                <?php else : ?>
                                    <p>Saldo Anda kosong.</p>
                                <?php endif; ?>
                            </H6>
                        ...
                        <div class="card-body py-0">
                            ...
                            <div class="table-responsive">
                                <table id="example" class="table align-middle table-row-bordered table-row-dashed gy-5" style="width:100%">
                                    <!--begin::Table body-->
                                    <tbody>
                                        <!--begin::Table row-->
                                            ...
                                            <tr>
                                                ...
                                                <td class="p-0">
                                                    <div class="d-flex align-items-center">
                                                        <div class="ps-3">
                                                            <a href="#" class="text-gray-800 fw-boldest fs-5 text-hover-primary mb-1"><?php echo $trx['nama']; ?></a>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="p-0">
                                                ...
                                                <td class="p-0">
                                                    <div class="d-flex align-items-center">
                                                        <?php if ($trx['jml_byr'] == 0) : ?>
                                                            <!-- Tombol Bayar dengan atribut data-id untuk menyimpan ID transaksi dan data-jml-trx untuk menyimpan jumlah transaksi -->
                                                        ...
                                                        <?php endif; ?>
                                                        <!-- Tambahkan input tersembunyi untuk menyimpan jml_trx -->
...
<div class="modal fade" id="trxModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-image: url('<?php echo base_url('assets/media/logos/payfazz.png'); ?>'); background-size: 100px; background-repeat: no-repeat; background-position: center center;">
                ...
                <form id="formTambahTrx" method="post">
                    <div class="mb-3">
                        <label for="j_trx" class="form-label mb-3">
                            <p class="badge badge-info"> Jenis Transaksi:</p>
                        </label> &nbsp;&nbsp;
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="kategori" id="kategori">
                            ...
                            <?php foreach ($kategori_data as $kategori) : ?>
                                <?php if (in_array($kategori['id'], [6, 7, 8, 11, 12])) : ?>
...
<script>
    ...
    function tambahTrx() {
        ...
        xhttp.open("POST", "<?php echo base_url('admin/trx/tambah_trx_payfazz'); ?>", true);
    ...
    function prosesPembayaran() {
        ...
        $.ajax({
            url: '<?php echo base_url("admin/trx/bayar_trx_payfazz"); ?>',
            type: 'POST',
            data: {
                id: idTransaksi,
                jml_byr: jmlByr
    ...
    function batalkanTransaksi(id) {
        $.ajax({
            type: "POST",
            url: "<?php echo base_url("admin/trx/batalkan_trx_fazz"); ?>",
            data: {
                idTrx: id
            },
            success: function(response) {
                console.log('Data berhasil dibatalkan:', response);
                Swal.fire({
                    icon: 'success',
    ...
    function prosesHapus(id) {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url("admin/trx/hapus_trx_payfazz"); ?>', // Ganti dengan URL yang sesuai untuk menghapus data
            data: {
                id: id

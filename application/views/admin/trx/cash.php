                ...
                <div class="col-xxl-12">
                    ...
                    <div class="card card-xxl-stretch">
                        ...
                        <div class="card-header border-0 pt-5 pb-3">
                            <!--begin::Card title-->
                            <h3 class="card-title fw-bolder text-gray-800 fs-2">List Trx Cash </h3>
                            <H6 class="card-title fw-bolder text-blue-500 fs-2"> <?php if ($saldo_cash > 0) : ?>
                                    <small class="text-blue-500"> Saldo Anda: Rp <?php echo number_format($saldo_cash, 0, ',', '.'); ?></small>
                                <?php else : ?>
                ...
                <form id="formTambahTrx" method="post">
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="kategori" id="kategori">
                            <option value="" disabled selected>Tabungan</option>
                            <?php foreach ($kategori_data as $kategori) : ?>
                                <?php if (in_array($kategori['id'], [10, 13])) : ?>
...
<script>
    ...
    function tambahTrx() {
        ...
        var params = "&kategori=" + encodeURIComponent(kategori) + "&jml_trx=" + encodeURIComponent(jml_trx);
        ...
        xhttp.open("POST", "<?php echo base_url('admin/trx/tambah_trx_cash'); ?>", true);
    ...
    function prosesPembayaran() {
        ...
        $.ajax({
            url: '<?php echo base_url("admin/trx/bayar_trx_cash"); ?>',
            type: 'POST',
            data: {
                id: idTransaksi,
                jml_byr: jmlByr
    ...
    function batalkanTransaksi(id) {
        $.ajax({
            type: "POST",
            url: "<?php echo base_url("admin/trx/batalkan_trx_cash"); ?>",
            data: {
                idTrx: id
            },
    ...
    function prosesHapus(id) {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url("admin/trx/hapus_trx_cash"); ?>', // Ganti dengan URL yang sesuai untuk menghapus data
            data: {
                id: id

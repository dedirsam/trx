                ...
                <div class="col-xxl-12">
                    ...
                    <div class="card card-xxl-stretch">
                        ...
                        <div class="card-header border-0 pt-5 pb-3">
                            <!--begin::Card title-->
                            <!--begin::Title--><?php if (!empty($saldo_cash)) : ?>
                                <h3 class="text-blue fw-bolder fs-2qx me-5">Saldo Cash Saat ini = Rp<?php echo $total_saldo_cash; ?>
                                    <?php else : ?>Saldo Cash anda Tidak ada</h3>
                            <?php endif; ?>
                            <!--end::Card title-->
                        </div>
                        <!--end::Header-->
                        ...
                        <div class="card-body py-0">
                            ...
                            <button type="button" class="btn btn-primary" onclick="showUpdateModal(<?php echo $total_saldo_cash; ?>)">
                                <svg width="50px" height="50px" viewBox="0 0 25.00 25.00" fill="none" xmlns="http://www.w3.org/2000/svg" transform="matrix(1, 0, 0, 1, 0, 0)">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
...
<div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updateModalLabel">Tambah Saldo</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" onclick="tambahSaldo()">Tambah</button>
...
<script>
    ...
    function tambahSaldo() {
        ...
        xhttp.open("POST", "<?php echo base_url('admin/cash/tambah_saldo'); ?>", true);
    ...
    function updateSaldo() {
        ...
        xhttp.open("POST", "<?php echo base_url('admin/cash/update_saldo'); ?>", true);
        xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");

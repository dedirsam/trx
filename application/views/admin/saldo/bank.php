                ...
                <div class="col-xxl-12">
                    ...
                    <div class="card card-xxl-stretch">
                        ...
                        <div class="card-header border-0 pt-5 pb-3">
                            <!--begin::Card title-->
                            <!--begin::Title--><?php if (!empty($saldo_bank)) : ?>
                                <h3 class="text-blue fw-bolder fs-2qx me-5">Saldo Bank Saat ini = Rp<?php echo $total_saldo_bank; ?>
                                    <?php else : ?>Saldo Bank anda Tidak ada</h3>
                            <?php endif; ?>
                            <!--end::Card title-->
                        </div>
                        <!--end::Header-->
                        ...
                        <div class="card-body py-0">
                            ...
                            <button type="button" class="btn btn-primary" onclick="showUpdateModal(<?php echo $total_saldo_bank; ?>)">
                                <svg width="50px" height="50px" viewBox="0 0 25.00 25.00" fill="none" xmlns="http://www.w3.org/2000/svg" transform="matrix(1, 0, 0, 1, 0, 0)">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
...
<script>
    ...
    function tambahSaldo() {
        ...
        xhttp.open("POST", "<?php echo base_url('admin/bank/tambah_saldo'); ?>", true);
    ...
    function updateSaldo() {
        ...
        xhttp.open("POST", "<?php echo base_url('admin/bank/update_saldo_bank'); ?>", true);
        xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
